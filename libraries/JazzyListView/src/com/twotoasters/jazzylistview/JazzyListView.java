...
public class JazzyListView extends ListView {
    ...
    /**
     * Sets the duration of the item animation.
     *
     * @param transitionDurationMillis The duration of the animation, in milliseconds.
     */
    public void setDuration(int transitionDurationMillis) {
        mHelper.setDuration(transitionDurationMillis);
    }
}
